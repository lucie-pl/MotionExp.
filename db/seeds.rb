...
MovieDirector.create(movie: inception, director: scorsese)
MovieDirector.create(movie: taxi_driver, director: scorsese)
MovieDirector.create(movie: interstellar, director: scorsese)
...
second_save_item = SaveItem.create(user: User.first, history: true, marked: false, title: shutter_island.title, year: shutter_island.year, api_movie_id: shutter_island.id, poster: shutter_island.poster)
SaveItem.create(user: User.first, history: true, marked: false, title: the_departed.title, year: the_departed.year, api_movie_id: the_departed.id, poster: the_departed.poster)
